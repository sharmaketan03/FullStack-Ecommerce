...
//             let response=await instance.get("/app/detail/get/" + x)
...
//             <img src={item.PrimaryImage} alt="" className="w-full h-full object-contain" />
//           </div>
//           <div className="flex-1">
//             <h2 className="text-xl font-semibold text-gray-800">{item.title}</h2>
//             <h3 className="text-gray-600">Discountedprice: ${item.Discountedprice}</h3>
//             <h3 className="text-gray-600">Rating: {4.5}</h3>
//             <h3 className="text-gray-600">Count: {9}</h3>
...
//                 -
//               </button>
//               <span className="text-lg font-medium">{Quantity[item.id] || 1}</span>
//               <button
...
//     {/* <span className="block text-right text-xl font-semibold text-gray-800">
